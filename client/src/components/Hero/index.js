...
const Hero = () => {
  ...
  return (
    <main className="container min-h-screen flex flex-col items-center justify-center px-2">
      <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-7xl">
        ...
        <div className="md:w-1/2 flex flex-col items-center">
          <div className="bg-gray-200 shadow-xl px-4 pt-6 pb-8 mb-4 dark:bg-gray-800 w-full max-w-lg rounded-xl">
            {logoutMessage ? (
              <p className="text-xl font-semibold text-center text-green-700 dark:text-green-400 transition-opacity duration-500">
                {logoutMessage}
              </p>
            ) : (
              <>
                ...
                <p className="text-sm font-[Times_New_Roman] text-justify">
                  Our platform empowers team members to build comprehensive
                  profiles, upload photos, and update details such as positions,
                  names, jersey numbers, and more. It facilitates skill
                  endorsements and star ratings among teammates. Additionally,
                  users can engage in messaging, liking, commenting on posts,
                  and direct communication, enhancing team interaction and
                  collaboration.
                </p>
              </>
            )}
