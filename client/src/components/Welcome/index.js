...
const Welcome = ({ username }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-lg shadow-xl bg-gradient-to-br from-indigo-800 to-white">
      <h1 className="text-4xl md:text-6xl text-center font-bold mb-8 text-gray-800 p-5">
        Welcome <span className="text-light">{username}</span> to the Roster Hub
      </h1>
